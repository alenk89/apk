            ...
            if (keywoard.value.length < 6 || keywoard.value.length > 11) {
                ...
                if (keywoard.value.length < 4) {
                    ...
                    if (x == 0851 && y == 5 || x == 0851 && y == 6 || x == 0851 && y == 7) {
                        ...
                        keywoard.classList.remove('is-invalid');
                        keywoard.classList.add('is-valid');
                        oprator.innerText = "TELKOMSEL"
                        $('#produk').empty();
                        $('#produk').append(`
                        <option id="" value="">Telkomsel</option>
                        `)
                        tampil_produk("pulsa-telkomsel-368959", "1");
                    }
                    // Indosat
                } else if (x == 0814 || x == 0815 || x == 0816 || x == 0855 || x == 0856 || x == 0857 || x == 0858) {
                    keywoard.classList.remove('is-invalid');
                    keywoard.classList.add('is-valid');
                    oprator.innerText = "INDOSAT"
                    $('#produk').empty();
                    $('#produk').append(`
                ...
                // Smartfreen
                    ...
                    keywoard.classList.remove('is-invalid');
                    keywoard.classList.add('is-valid');
                    oprator.innerText = "SMARTFREEN"
                    $('#produk').empty();
                    $('#produk').append(`
                        <option id="" value="">Pulsa Smartfreen</option>

                        `)
                    tampil_produk("smartfren-418723", "6");
                }
            }
        };
        ...
        function tampil_produk(kategori, ket) {
            ...
            $.getJSON(url + kategori + '&ket=' + ket + '&link=' + link + '&token=' + aktivasi, function (data) {
                ...
                if (data != null) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                      ...
                      <div class="produk base shadow-sm d-flex mb-2">
                        <div class="col-2 d-flex align-items-center" onclick="klik(\'` + harga + `\',\'` + nama + `\',\'` + id_produk + `\')">
                          <div class="">
                            <img src="https://i.ibb.co/C523ZKR/pulsa.png" alt="pulsa" style="width:60px;justify-content: center;">
                          </div>
                        </div>
                        <div class="col-10 ml-5" onclick="klik(\'` + harga + `\',\'` + nama + `\',\'` + id_produk + `\')">
                          <div class="d-flex flex-column ml-5" onmouseenter="document.getElementById('`+ id_produk + `').style='color:white'" onmouseleave="document.getElementById('` + id_produk + `').style='color:#7743DB'">
                            <span class="" id="`+ id_produk + `">
                              <b>` + nama + `</b>
                            </span>
                            <span style="margin-top: -3px;">
                              Pulsa Reguler
                            </span>
                            <span class="text-dark fw-bolder" style="margin-top: -3px;">
                              `+ harga + `
                            </span>
                          </div>
                        </div>
          ...
          <div class="d-flex justify-content-center flex-column align-items-center" style="margin-top:50%" id="rol">
          <img src="https://i.ibb.co/HBBWwj4/out-of-stock.png" alt="logo-new" class="img-logo opacity-50">
        ...
        function Loading() {
            ...
            $('#produk_diamond').append(`
                <div class="d-flex justify-content-center " style="margin-top:50%" id="rol">
                    ...
                    <img src="https://i.ibb.co/b1fW6n5/loading.gif" alt="loading" style="width:120px" >
                    </div>
                </div>
            `)
        }
